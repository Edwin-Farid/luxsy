...
const Profile: NextPage = () => {
  ...
  return (
    <BaseLayout> <div className="pb-16 pt-8 bg-white overflow-hidden min-h-screen">
                  ...
                  <div className="pb-16 space-y-6">
                    ...
                    <div className="flex">
                      ...
                      <button
                        ...
                        type="button"
                        className="disable: text- gray-400 disabled:cursor-not-allowed flex-1 ml-3 bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
