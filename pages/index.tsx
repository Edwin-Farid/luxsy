...
const Home: NextPage = () => {
  ...
  return (
    <BaseLayout>
      <img className="w-[1440px] h-[550px]" src="/images/hero/hero.webp" />
      ...
      <div className="py-16 bg-white overflow-hidden min-h-screen">
        <div className="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
          ...
          <div className="text-stone-500 text-xl font-normal font-['Open Sans'] tracking-widest text-center lg:pt-48">REALISME</div>
      ...
      <img className="w-[1440px] h-[788px]" src="/images/hero/statue.webp" />
      ...
      <div className="py-16 bg-white overflow-hidden min-h-screen">
        <div className="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
          ...
          <div className="text-stone-500 text-xl font-normal font-['Open Sans'] tracking-widest text-center lg:pt-48">ABSTRACK</div>
          <div className="text-stone-500 text-[40px] font-normal font-['Open Sans'] text-center">LY By The Art </div>
      ...
      <img className="w-[1440px] h-[788px]" src="/images/hero/abstrack.webp" />
