            ...
            {!nftURI &&
              <div className="flex">
                ...
                <Switch
                  ...
                  className={`${hasURI ? 'bg-[#4F473E]' : 'bg-[#776B5D]'}
                  ...
                  <div className="shadow sm:rounded-md sm:overflow-hidden">
                        ...
                        <div>
                          ...
                          <div className="mt-1 flex rounded-md shadow-sm">
                            <input
                              ...
                              name="uri"
                              id="uri"
                              className="focus:ring-[#776B5D] focus:border-[#776B5D] flex-1 block w-full rounded-md sm:text-sm border-gray-300"
                    ...
                    {nftURI &&
                      <div className='mb-4 p-4'>
                        ...
                        <div>
                          <Link href={nftURI} className="underline text-[#4F473E]">
                            {nftURI}
                          </Link>
                        </div>
                      </div>
                    ...
                    <div className="px-4 py-3 bg-gray-50 text-right sm:px-6">
                      <button
                        onClick={creatNft}
                        type="button"
                        className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[#776B5D] hover:bg-[#4F473E] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#776B5D]"
                      >
                        List
                      </button>
                    </div>
                  ...
                  <div className="shadow sm:rounded-md sm:overflow-hidden">
                    <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <div>
                          ...
                          <div className="mt-1">
                            <input
                              value={nftMeta.height}
                              onChange={handleChange}
                              id="height"
                              name="height"
                              type='number'
                              className="shadow-sm focus:ring-[#776B5D] focus:border-[#776B5D] mt-1 block w-full sm:text-sm border border-gray-300 rounded-md"
                              placeholder="Some nft height..."
                            />
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                            <div className="space-y-1 text-center">
                              ...
                              <div className="flex text-sm text-gray-600">
                                <label
                                  htmlFor="file-upload"
                                  className="relative cursor-pointer bg-white rounded-md font-medium hover:text-[#4F473E] text-[#776B5D] focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-[#776B5D]"
                                >
                        ...
                        {nftMeta.attributes.map(attribute =>
                          <div key={attribute.traitType} className="col-span-6 sm:col-span-6 lg:col-span-2">
                            ...
                            <input
                              ...
                              className="mt-1 focus:ring-[#776B5D] focus:border-[#776B5D] block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                            />
                          </div>
                        )}
                      </div>
                    ...
                    <div className="px-4 py-3 bg-gray-50 text-right sm:px-6">
                      <button
                        ...
                        type="button"
                        className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white hover:bg-[#4F473E] bg-[#776B5D] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#776B5D]"
                      >
                        List
                      </button>
                    </div>
