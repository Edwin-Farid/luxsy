...
contract NftMarket is ERC721URIStorage, Ownable {
  ...
  function placeNftOnSale(uint tokenId, uint newPrice) public payable{
    ...
    require(msg.value == listingPrice, "Price must be equal to listing prices");
  ...
  //balance 0 mapping 1, balance 1 mapping 2, balance 2 mapping 3.
  //token 1 to length 0, token 2 to length 1, token 3 to length 2.
